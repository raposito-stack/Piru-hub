    local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
        ...
        if IsMobile then 
            ...
            ImageLabel.Image = "rbxassetid://89766420605354"
        ...
        function Window:NewTab(mmb)
            ...
            function newmm:NewParagraph(cf)
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Piru hub"
        ...
        function SaveSettings2()
            ...
            if not isfolder("Piru hub") then
                makefolder("Piru hub")
            end
            writefile("Piru hub/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
        end
        ...
        function ReadSetting2()
            local s, e =
                ...
                function()
                    ...
                    return HttpService:JSONDecode(readfile("Piru hub/" .. SaveFileName2))
                end
            )
            if s then
                return e
